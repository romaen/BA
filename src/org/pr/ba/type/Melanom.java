...
public class Melanom extends Annotation {
  ...
  public final static int typeIndexID = JCasRegistry.register(Melanom.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Melanom() {/* intentionally empty block */}
   ...
   */
  public Melanom(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Melanom(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
